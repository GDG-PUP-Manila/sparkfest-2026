    ...
    >
      <div className="relative w-full h-full overflow-hidden">
        ...
        {variant === "right-large" ? (
          <>
            <div
              className={`absolute top-0 right-0 xl:top-0 xl:right-1 pointer-events-none ${largeCornerClass}`}
            >
              <Image
                src={assets.blueTopRight}
                alt=""
                fill
                unoptimized
            ...
            <div
              className={`absolute top-0 left-0 pointer-events-none xl:h-30 xl:w-6 ${smallCornerClass}`}
            >
              <Image
                src={assets.blueTopLeft}
                alt=""
                fill
                unoptimized
                className="object-cover mix-blend-plus-lighter"
          ...
          <>
            <div
              className={`absolute top-0 left-0 xl:top-1 xl:left-3 pointer-events-none ${largeCornerClass}`}
            >
              <Image
                src={assets.redTopLeft}
                alt=""
                fill
                unoptimized
                className={`object-cover ${leftCornerBlend}`}
              />
            </div>
            <div
              className={`absolute top-0 right-0 pointer-events-none xl:h-30 xl:w-6 ${smallCornerClass}`}
            >
              <Image
                src={assets.blueTopLeft}
                alt=""
      ...
      <div
        className="h-[10%] border-x-2 border-b-2 border-navy-900 bg-black-02 opacity-10"
        aria-hidden
      />
    </div>
  );
...
export default function RoadToDemo() {
  return (
    <section className="relative w-full overflow-hidden bg-navy-900 flex justify-center">
      {/* Centered background container restricted to max width of 1920px to prevent sticking/enlarging when zoomed out */}
      <div className="absolute inset-0 mx-auto max-w-480 bg-linear-to-b from-panel-blue via-panel-blue-2 to-navy-900 pointer-events-none">
        <Image
      ...
      <div className="relative w-full aspect-[320/1560] md:aspect-[768/3200] xl:aspect-[1920/5300] max-w-[1920px] overflow-hidden">
        {/* === BACKGROUND ELEMENTS === */}
        <DecAsset
          posClass="top-[75.83%] xl:top-[82.98%] left-1/2 -translate-x-1/2"
          sizeClass="w-[247.4%] h-[6.15%]"
          src={assets.platform1}
          imageClass="object-contain max-w-none"
          containerOpacity="opacity-40"
        />
        <DecAsset
          posClass="bottom-0 xl:-bottom-110 left-33 -translate-x-1/2"
          sizeClass="w-[500.4%] h-[25.15%]"
          src={assets.platform2}
          imageClass="object-contain max-w-none"
          containerOpacity="opacity-40"
        />
        <DecAsset
          posClass="left-[7.5%] top-[6.02%]"
          sizeClass="w-[37.5%] h-[7.69%]"
          src={assets.cloud1}
        />
        <DecAsset
          posClass="left-[-8.75%] top-[10%]"
          sizeClass="w-[50%] h-[10.25%]"
          src={assets.cloud1}
        />
        ...
        <DecAsset
          posClass="left-[62.5%] xl:left-[85%] top-[3.84%] xl:top-[8%]"
        ...
        <DecAsset
          posClass="left-[68.75%] top-[65.38%]"
          sizeClass="w-[25%] h-[5.12%]"
          src={assets.cloud2}
        />
        <DecAsset
          posClass="left-[85%] top-[65.89%]"
          sizeClass="w-[8.75%] h-[1.79%]"
          src={assets.cloud3}
        />

        {/* Grids */}
        <DecAsset
          posClass="left-[7.49%] md:left-[5.46%] xl:left-[2.5%] top-[15.26%] md:top-[10.04%] xl:top-[10.07%]"
          sizeClass="w-[22.81%] md:w-[20.88%] xl:w-[25.5%] h-[4.4%] md:h-[4.72%] xl:h-[8.75%]"
          src={assets.grid5}
          imageClass="object-cover mix-blend-plus-lighter"
        />
        <DecAsset
          posClass="left-[68.11%] md:left-[69.73%] xl:left-[70%] top-[30.12%] md:top-[25.81%] xl:top-[26.81%]"
          sizeClass="w-[25%] md:w-[24.98%] xl:w-[25%] h-[1.79%] md:h-[2.00%] xl:h-[3.06%]"
          src={assets.grid6}
          imageClass="object-cover"
        />
        <DecAsset
          posClass="left-[7.22%] md:left-[5.21%] xl:left-[6%] top-[52.56%] md:top-[49.88%] xl:top-[52.53%]"
          sizeClass="w-[20%] md:w-[19.15%] xl:w-[25%] h-[1.53%] md:h-[1.53%] xl:h-[3.06%]"
          src={assets.grid7}
          imageClass="object-cover"
        />
        <DecAsset
          posClass="left-[73.73%] md:left-[74.50%] xl:left-[72%] top-[52.56%] md:top-[49.71%] xl:top-[55.00%]"
          sizeClass="w-[20%] md:w-[20.38%] xl:w-[25.5%] h-[4.10%] md:h-[4.89%] xl:h-[9.25%]"
          src={assets.grid3}
          imageClass="object-cover"
        />
        ...
        <DecAsset
          ...
          src={assets.xlRedRight}
          imageClass="object-cover"
        />
        <DecAsset
          posClass="hidden xl:block xl:left-[8.05%] xl:top-[42.35%]"
          sizeClass="xl:w-[2.55%] xl:h-[7.55%]"
          src={assets.xlYellowLeft}
          imageClass="object-cover"
        />
        <DecAsset
          posClass="hidden xl:block xl:left-[94.3%] xl:top-[84.67%]"
          sizeClass="xl:w-[2.55%] xl:h-[7.55%]"
          src={assets.xlRedRight}
          imageClass="object-cover"
        />
        ...
        <RoadmapCard
          index={0}
          baseClass="left-[18.77%] md:left-[15.78%] xl:left-[13.60%] top-[16.49%] md:top-[11.35%] xl:top-[14.36%]"
          rectangleSrc={assets.blueRectangle}
          xlRectangleSrc={assets.xlBlueRectangle}
          variant="right-large"
          leftCornerBlend="mix-blend-plus-lighter"
        ...
        <RoadmapCard
          index={1}
          baseClass="left-[42.52%] md:left-[40.38%] xl:left-[35.00%] top-[30.92%] md:top-[26.81%] xl:top-[28.45%]"
          rectangleSrc={assets.redRectangle}
          xlRectangleSrc={assets.xlRedRectangle}
          variant="left-large"
          leftCornerBlend="mix-blend-plus-lighter"
          largeCornerClass="w-[12.26%] h-[52.03%] xl:w-[8.5%] xl:h-[89%]"
          smallCornerClass="xl:!top-1 xl:!right-3"
        />
        <RoadmapCard
          index={2}
          baseClass="left-[7.22%] md:left-[5.21%] xl:left-[10.96%] top-[41.60%] md:top-[38.25%] xl:top-[42.54%]"
          rectangleSrc={assets.yellowRectangle}
          xlRectangleSrc={assets.xlYellowRectangle}
          variant="right-large"
          largeCornerClass="w-[12.26%] h-[52.03%] xl:w-[8.5%] xl:h-[88%] xl:top-1 xl:right-3"
          smallCornerClass="xl:!top-1 xl:!left-3"
        />
        <RoadmapCard
          index={3}
        ...
        <RoadmapCard
          index={4}
          baseClass="left-[7.5%] md:left-[5.46%] xl:left-[5.21%] top-[66.48%] md:top-[64.89%] xl:top-[70.74%]"
          rectangleSrc={assets.blueRectangle}
          xlRectangleSrc={assets.xlBlueRectangle}
          variant="right-large"
          largeCornerClass="w-[12.26%] h-[52.03%] xl:w-[8.5%] xl:h-[90.9%]"
        ...
        <RoadmapCard
          index={5}
          baseClass="left-[41.63%] md:left-[39.57%] xl:left-[45.81%] top-[78.64%] md:top-[77.91%] xl:top-[84.83%]"
          rectangleSrc={assets.redRectangle}
          xlRectangleSrc={assets.xlRedRectangle}
          variant="left-large"
          leftCornerBlend="mix-blend-plus-lighter"
